...
[![Coding Profile](https://img.shields.io/badge/StopStalk-orange?style=for-the-badge)](https://stopstalk.com/user/profile/purush)
[![Profile Views](https://komarev.com/ghpvc/?username=purush-o7&style=for-the-badge&color=7aa2f7&label=PROFILE+VIEWS)](https://github.com/purush-o7)
...
**Languages:** Python · PHP · JavaScript · HTML/CSS · Java · SQL

**Frameworks & Libraries:** FastAPI · Django · React · Next.js · Frappe · Odoo · Ajax · jQuery

**Cloud & DevOps:** Azure (App Services, Functions, Blob, ML) · GCP · Docker · Apache · AWS
...
### 🥽 KovilLens — Mixed Reality for Cultural Heritage
*Apr 2023 – Feb 2024 | Major Project — Published at ICVR 2025*

Integrated a detailed 3D reconstruction of the **Moovar Kovil temple** into the **HoloLens mixed-reality environment**, with stable placement, proper scaling, and accurate spatial alignment. Validated for historical accuracy and contextual sensitivity by academic experts. Published as *"KovilLens: A Mixed Reality Application for Digital Preservation and Exploration of Moovar Kovil"* at the **11th International Conference on Virtual Reality (ICVR 2025)**, Wageningen, Netherlands.

**Tech:** Unity · Microsoft HoloLens · Mixed Reality Toolkit (MRTK)

---

### 🍑 Sapota Ripeness & Shelf-Life Detection
*Mar 2022*

Built deep-learning models combining **thermal imaging and RGB image analysis** to classify sapota ripeness levels and predict shelf life, achieving **~88% accuracy**. Engineered a custom CNN with transfer learning for multi-stage classification and implemented an **SVM bruise detection pipeline** that improved precision by ~15%.

**Tech:** Python · TensorFlow · Custom CNN · SVM · Thermal Imaging · OpenCV · Data Augmentation
...
Led a team of four to build a **Windows desktop app** for recording companies — managing artists, albums, songs, contracts, and metadata. Built the core UI in **Java Swing** with **JDBC + PostgreSQL** backend, including structured schema design, validation rules, and transaction-safe operations.
...
> **"KovilLens: A Mixed Reality Application for Digital Preservation and Exploration of Moovar Kovil"**
> Accepted at the **11th International Conference on Virtual Reality (ICVR 2025)**, Wageningen, Netherlands, July 2025.
...
[![GitHub Streak](https://streak-stats.demolab.com?user=purush-o7&theme=tokyonight&hide_border=true)](https://github.com/purush-o7)

[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=purush-o7&theme=tokyo-night&hide_border=true)](https://github.com/purush-o7)
...
Cloud Computing · Full Stack Development · Competitive Programming · Generative AI · Mixed Reality
